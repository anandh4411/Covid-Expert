                    ...
                    <?php
                        if(!isset($_SESSION['user-id'])) {
                            ...
                            echo '<li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="page" href="pages/notification.php">Notification</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="page" href="php/user/logout.php">Logout</a>
                                </li>';
                        }
                    ?>
                </ul>
                ...
                <div class="row bottom-row">
                    ...
                    <div class="col-lg-4">
                        <div class="row vaccine-book">
                            ...
                            <a class="btn" href="pages/vaccine-book.php">Book now</a>
                        </div>
