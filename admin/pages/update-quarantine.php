                    ...
                    <div class="row">
                        <div class="col-md-5 covid-case card-tile">
                            <?php
                                include '../php/db.php';
                                $id = $_GET["id"];
                                $query = "SELECT * FROM quarantine_centre WHERE id=$id";
                                $result = mysqli_query($connect, $query);
                                while($row = mysqli_fetch_array($result)){
                                    echo '<form method="post" action="../php/quarantine/update-centre.php">
                                            ...
                                            <div class="form-group">
                                                <input value="'.$row["rooms"].'" name="rooms" type="number" class="form-control" id="exampleInputPassword1"
